...
Using both the random graph and the word vector graph, we can see that the optimal
clustering occurs when $c \approx 2$.\\
\begin{figure}[!htb]
  \centering{
\includegraphics[width=0.45\textwidth]{images/error_ratio_as_c_varies.png}
\includegraphics[width=0.45\textwidth]{images/error_ratio_as_c_varies_word_vector.png}

}
  \caption{\label{fig:errors-as-c-varies}
  In both the random graph (left) and word vector graph (right), the clustering is
  optimal around $c = 2$.}
\end{figure}
